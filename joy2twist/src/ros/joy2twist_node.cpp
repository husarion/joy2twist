...
void Joy2TwistNode::declare_parameters() {
  this->declare_parameter<float>("velocity_factor.fast",
                                 default_velocity_factors_.at(FAST));
  this->declare_parameter<float>("velocity_factor.regular",
                                 default_velocity_factors_.at(REGULAR));
  this->declare_parameter<float>("velocity_factor.slow",
                                 default_velocity_factors_.at(SLOW));
}
